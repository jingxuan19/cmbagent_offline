...
def register_functions_to_agents(cmbagent_instance):
    ...
    # Ollama patch, default to control
    def post_execution_transfer(context_variables: ContextVariables,
                                execution_status: Literal["success", "failure", "unknown"] = "success",
                                next_agent_suggestion: Literal["engineer",
                                                               "classy_sz_agent",
                                                               "installer",
                                                               "camb_agent",
                                                               "cobaya_agent",
